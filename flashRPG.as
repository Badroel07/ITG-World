...
*/
//game screen
var screen_w:int = 1280; //lebar project 
var screen_h:int = 720;
...
var t_size:int = 16; //tile size : ukuran tile
var c_size:int = 32;
...
function findDoor(newMap){
	...
	trace(door_id+" new door is "+doorX+" "+doorY+" for map "+last_map);		
}
...
function center_screen():void{
	if (game_output == "android"){
		...
		game.x = -char.x*game.scaleX+screen_w/2;
		game.y = -char.y*game.scaleY+screen_h/2;
	}
}
...
function set_char(link_name:String):MovieClip{
	...
	rectangle.graphics.drawRect(-c_size/2, -c_size, c_size, c_size); 
